...
const { signUpRequestValidator ,signUpRequestValidatorResult,loginRequestValidator,loginRequestValidatorResult,editRequestValidator,editRequestValidatorResult} = require('../validators')
...
router.put('/update/a/user',editRequestValidator,editRequestValidatorResult,authenticate,updateUser)
